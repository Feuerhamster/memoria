...
public class Result
{
	...
	/// </summary>
	public CustomApiException SelectApiError(CustomApiException expected, CustomApiException unexpected)
	{
		return FailureType == EFailureType.Expected ? expected : unexpected;
	}
}
